...
with open('/Users/mithramedavarapu/Desktop/Placements/data/projects/rhythmic-beat-prediction-main/scripts/dt_amp_mag_classifier.pkl', 'rb') as f:
  loaded_dt_model = pickle.load(f)
  
with open('/Users/mithramedavarapu/Desktop/Placements/data/projects/rhythmic-beat-prediction-main/scripts/label_encoder.pkl', 'rb') as f:
  lc = pickle.load(f)

j_model = load('/Users/mithramedavarapu/Desktop/Placements/data/projects/rhythmic-beat-prediction-main/scripts/dt_amp_mag_classifier.joblib')
...
cnn_model = CNN()
cnn_model.load_state_dict(torch.load('/Users/mithramedavarapu/Desktop/Placements/data/projects/rhythmic-beat-prediction-main/scripts/cnn_model.pt'))
